...
public class ventanaMercanciaMod extends JFrame {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ventanaMercanciaMod frame = new ventanaMercanciaMod();
	 ...
	 * Create the frame.
	 */
	public ventanaMercanciaMod(int id, String nombre,float precio,String descripcion,int cantidad) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ventanaMercanciaMod.class.getResource("/imagenes/LogoIcon.png")));
		setTitle("Systemovie(Modificar)");
		...
		//llenar textbox con valores anteriores
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {//boton aceptar
				...
				conexion.actualizarMercancia(id,name, price, desc, cant);
				dispose();}
				catch(Exception eer)
				{
					//frame 
